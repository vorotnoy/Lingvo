      ...
      <div className={s.info_block}>
        <div className={s.info_block__content}>
          <h2 className={s.info_block__title}>
            Unlock your potential with the best <span className={s.info_block__span}>language</span> tutors
          </h2>
          ...
          <button type="button" className={s.info_block__btn}>Get started</button>
        </div>
